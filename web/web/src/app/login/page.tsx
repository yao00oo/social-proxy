    ...
    <div className="min-h-screen bg-surface flex items-center justify-center">
      <div className="bg-white rounded-2xl border border-outline-variant/20 p-10 w-full max-w-sm text-center space-y-6 shadow-lg">
        <div>
          ...
          <h1 className="font-[Manrope] font-extrabold text-xl text-on-surface">Social Proxy</h1>
          <p className="text-outline text-sm mt-1">AI 社交关系管理</p>
        </div>
        <button
        ...
        <p className="text-outline text-xs">登录后可管理你的社交消息、联系人和 AI 助手</p>
      </div>
    </div>
  )
}
